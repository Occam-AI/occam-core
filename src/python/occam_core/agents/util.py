...
class EmailAttachmentMetadataModel(BaseModel):
    ...
    1. As a base for the email attachment model that's sent to the front-end
       to display a proposal to the user of a draft email.

    2. As part of the user send confirmation model, to trace what a user
       approved to send and the content that's in it.
    ...
    2. TODO: When they're part of the send confirmation, it captures attachments
       that would be included in the actual email being sent.
    """
